...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-06-21T11:47:26.237-07:00")
public class MultiLineString extends Geometry {
  @SerializedName("coordinates")
  private List<List<Point2D>> coordinates = null;

  public MultiLineString coordinates(List<List<Point2D>> coordinates) {
    this.coordinates = coordinates;
    return this;
  }

  public MultiLineString addCoordinatesItem(List<Point2D> coordinatesItem) {
    if (this.coordinates == null) {
      this.coordinates = new ArrayList<List<Point2D>>();
    }
